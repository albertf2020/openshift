...
function fetch_repo() {
  ...
  curl -sSL "https://github.com/openshift/openshift-ansible/archive/refs/tags/openshift-ansible-3.11.630-1.zip" \
    > openshift.zip
  unzip openshift.zip
  mv openshift-ansible-openshift-ansible-* openshift-ansible
}
